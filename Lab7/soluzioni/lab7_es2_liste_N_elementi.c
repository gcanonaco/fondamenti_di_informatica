...
/*
Generalizzare il problema precedente per permettere l’inserimento
 di un numero n di elementi definito dall’utente a runtime.
 Si utilizzino le funzioni viste a lezione per operare sulle liste
 */
